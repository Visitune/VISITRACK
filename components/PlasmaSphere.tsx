...
const PlasmaSphere: React.FC<{ className?: string }> = ({ className }) => {
    ...
    useEffect(() => {
        ...
        controls.enableZoom = false; // Disable zoom for sidebar decoration
      ...
      `,
        ...
        const pCount = 300; // Reduced for performance in sidebar
